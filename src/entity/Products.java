...
public class Products {
	...
	public Products(int productID, String product_name, double income_price, int quantity, double sale_price) {
		this.productID = productID;
		this.product_name = product_name;
		this.income_price = income_price;
		this.quantity = quantity;
	...
	public Products(int productID, String product_name, double income_price, int providerID, int quantity, double sales_price, int categoryID) {
		super();
		this.product_name = product_name;
		this.income_price = income_price;
		this.pv = pv;
	...
	public Products(int productID, String product_name) {
		this.productID = productID;
		this.product_name = product_name;
	}

    public Products(String product_name, Providers pv, Categorys cg) {
		super();
		this.product_name = product_name;
		this.pv = pv;
		this.cg = cg;
